...
(MAKE IN VARCHAR, MDL IN VARCHAR, PAYMENT IN NUMBER, PAY_YRS IN INTEGER)
AS
BEGIN
INSERT INTO CAR VALUES(SEQ.NEXTVAL, MAKE, MDL, PAYMENT, PAY_YRS);
COMMIT;
END;
/
...
EXECUTE MAKE_CAR('HONDA', 'CIVIC', 100000, 4);
